...
/*
if (HR_GRG_hasAmmoSource && !HR_GRG_ServiceDisabled_Rearm) then {
    {
...
if (HR_GRG_hasRepairSource && !HR_GRG_ServiceDisabled_Repair) then {
    {
        _x setDamage 0;
...
if (HR_GRG_hasFuelSource && !HR_GRG_ServiceDisabled_Refuel) then {
    {
