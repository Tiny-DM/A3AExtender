...
*/
    ...
    {
        private _uid = _x#0;
        if ([_uid, "TIME"] call A3AE_ONE_LIFE_FUNCTIONS_fnc_checkIfExpired) exitWith {Info_1("Timer expired for UID %1 player released!",_uid)};
    } forEach A3A_softBannedUIDList;
	sleep 4;
};