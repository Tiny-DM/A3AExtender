...
if (((count (airportsX select {sidesX getVariable [_x,sideUnknown] == teamPlayer}) == 3) && A3A_funnyEnding) || {!isNil "TNY_DEBUG" && {TNY_DEBUG}}) exitWith {
    [] spawn A3AE_ONE_LIFE_FUNCTIONS_fnc_serverCutscene;
};
