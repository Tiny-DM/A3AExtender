...
if (random 1 < 0.3 && (tierWar > 5) && !(isNil "_airport") && (isClass (configFile >> "vnx_credits")) && (_side == Invaders) && (allowUnfairSupports)) exitWith {
    // send the hate
    [_airport, _this] call A3AE_ONE_LIFE_FUNCTIONS_fnc_vnx_ac119orbit;
    250;
};
