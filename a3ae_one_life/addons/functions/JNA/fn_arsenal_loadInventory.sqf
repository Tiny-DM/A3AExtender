...
//remove items from containers
{
	...
	private _checkTags = _array#24;
	{
		_item = _x#0;
        if(_item find "ACE_dogtag_" != -1)then{
            _checkTags deleteAt _forEachIndex;
            _array set [24,_checkTags];
