...
// funny
#define DEAD_INFO_1     400
#define DEAD_INFO_2     401
#define DEAD_INFO_3     402
...
{
    _intelContent = selectRandomWeighted [TROOPS, 0, TIME_LEFT, 0.1, DEF_RESOURCES, 0.15, DECRYPTION_KEY, 0.5, CONVOY, 0, DEAD_INFO_1, 0.25];
    switch (_intelContent) do
    {
        ...
        case (DEAD_INFO_1):
        {
            _text = [1] call A3AE_ONE_LIFE_FUNCTIONS_fnc_revealDeadInfo;
        };
    };
};
...
{
    _intelContent = selectRandomWeighted [KEY_PACK, 0.6, ACCESS_AIR, 0, ACCESS_HELI, 0, ACCESS_ARMOR, 0, CONVOYS, 0, COUNTER_ATTACK, 0, DEAD_INFO_3, 0.4];
    switch (_intelContent) do
    {
        case (KEY_PACK):
        {
...
*/
        ...
        case (DEAD_INFO_2):
        {
            _text = [2] call A3AE_ONE_LIFE_FUNCTIONS_fnc_revealDeadInfo;
        };
    };
...
if (_intelType == "Large") then
{
    ...
    {
        _intelContent = selectRandomWeighted [TRAITOR, 0.3, MONEY, 0.4, DEAD_INFO_3, 0.3];
    }
    else
    {
        _intelContent = selectRandomWeighted [MONEY, 0.6, DEAD_INFO_3, 0.4];
    };
    switch (_intelContent) do
    {
        case (TRAITOR):
        ...
        case (DEAD_INFO_3):
        {
            _text = [3] call A3AE_ONE_LIFE_FUNCTIONS_fnc_revealDeadInfo;
        };
    };
};
