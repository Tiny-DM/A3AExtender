...
Example:
    ["update"] call A3A_GUI_fnc_commanderTab;
...
switch (_mode) do
{
    case ("update"):
    {
        ...
        switch (true) do 
        {
            case (_doAutoSwitchArty && _isMortarVic): { // If all is valid show fire mission view
                ...
                ["updateFireMissionView"] call A3A_GUI_fnc_commanderTab;
            };
            case (_hasGroup): { // If a group is selected show the single group view
                 ["updateSingleGroupView"] call A3A_GUI_fnc_commanderTab;
            };
            case (_doAutoSwitchArty): { // If no group is selected show the multiple groups view
                ["updateMultipleGroupsView"] call A3A_GUI_fnc_commanderTab;
            };
            default {
    ...
    case ("updateSingleGroupView"):
    {
        ...
        private _groupInfo = [_selectedGroup] call A3A_GUI_fnc_getGroupInfo;
        _groupInfo params [
            "_group",
            "_groupID",
            "_groupLeader",
        ...
        if _hasMortar then {
            ...
            _fireMissionButton ctrlEnable false;
            _fireMissionButton ctrlSetTooltip "High command mortars are disabled in hardcore";
        };
    ...
    case ("commanderMapClicked"):
    {
        ...
        */
        ...
        if (_selectedItem isEqualType grpNull) then {
            ...
            _commanderMap setVariable ["selectedMarker", locationNull];
            ["update"] call A3A_GUI_fnc_commanderTab; // Update single group view if applicable
        } else {
    ...
    case ("groupFastTravelButtonClicked"):
    {
        ...
        ["setHcMode", [true, _selectedGroup]] call A3A_GUI_fnc_fastTravelTab;
        ["switchTab", ["fasttravel"]] call A3A_GUI_fnc_mainDialog;
    };
    ...
    case ("fireMissionSelectionChanged"):
    {
        ...
        */
        ["updateFireMissionView", [_selection]] call A3A_GUI_fnc_commanderTab;
    };
