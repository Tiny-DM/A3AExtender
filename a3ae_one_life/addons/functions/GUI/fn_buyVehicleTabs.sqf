...
if (_tab isEqualTo "vehicles") then 
{
    ...
    private _added = 0;
    {
        ...
        */
        ...
        if (A3A_oneLifeBlockStatics && (_tab isEqualTo A3A_IDC_BUYSTATICMAIN)) then {
            ...
            private _inArea = _friendlyMarkers findIf { player inArea _x };
            if !(_inArea > -1) then { _button ctrlEnable false; _button ctrlSetTooltip "Statics can only be bought from airbases and HQ"; } ;
        };
