...
{
private _player = _x;
if ((_player distance _posHQ > 100) and (side _player in [teamPlayer,civilian]) and {A3A_softBannedUIDList findIf {_x#0 == getPlayerUID _player} == -1}) then {_absentPlayers pushBackUnique name _x;};
